...
public final class a {
    public AlertDialogC0015a a;
    public Activity b;
    public String c;
    public boolean d = false;
    public Handler e = new d(this, Looper.getMainLooper());

    /* JADX INFO: renamed from: roam.a.a.f.k.a$a, reason: collision with other inner class name */
    public final class AlertDialogC0015a extends AlertDialog {
        public final a a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AlertDialogC0015a(a aVar, Context context) {
            super(context);
            this.a = aVar;
        }
        ...
        public final void onCreate(Bundle bundle) {
            ...
            try {
                ...
                BitmapDrawable bitmapDrawable2 = new BitmapDrawable(context.getResources(), BitmapFactory.decodeStream(byteArrayInputStream, null, options));
                try {
            ...
            textView.setText(TextUtils.isEmpty(this.a.c) ? "正在加载" : this.a.c);
