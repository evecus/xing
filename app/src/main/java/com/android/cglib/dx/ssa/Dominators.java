...
public final class Dominators {
    ...
    public class DfsWalker implements SsaBasicBlock.Visitor {
        private int dfsNum;
        public final Dominators this$0;
        ...
        public void visitBlock(SsaBasicBlock ssaBasicBlock, SsaBasicBlock ssaBasicBlock2) {
            ...
            this.this$0.vertex.add(ssaBasicBlock);
            this.this$0.info[ssaBasicBlock.getIndex()] = dFSInfo;
        }
    }
    ...
    private void run() {
        ...
        while (true) {
            ...
            int i4 = 0;
            while (true) {
                int iNextSetBit = preds.nextSetBit(i4);
                if (iNextSetBit < 0) {
                    break;
                }
            ...
            while (!arrayList.isEmpty()) {
                ...
                if (this.info[ssaBasicBlockEval.getIndex()].semidom < this.info[ssaBasicBlockRemove.getIndex()].semidom) {
                    domInfo = this.domInfos[ssaBasicBlockRemove.getIndex()];
                } else {
                    domInfo = this.domInfos[ssaBasicBlockRemove.getIndex()];
                    ssaBasicBlockEval = dFSInfo.parent;
                }
                domInfo.idom = ssaBasicBlockEval.getIndex();
            }
            i3--;
        }
        for (i = 2; i <= size; i++) {
