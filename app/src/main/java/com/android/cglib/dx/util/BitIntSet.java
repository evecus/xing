...
public class BitIntSet implements IntSet {
    ...
    public IntIterator iterator() {
        return new IntIterator(this) { // from class: com.android.cglib.dx.util.BitIntSet.1
            private int idx;
            public final BitIntSet this$0;

            {
                this.this$0 = this;
                this.idx = Bits.findFirst(this.bits, 0);
            }
            ...
            public int next() {
                ...
                int i = this.idx;
                this.idx = Bits.findFirst(this.this$0.bits, i + 1);
                return i;
            }
        };
    }
