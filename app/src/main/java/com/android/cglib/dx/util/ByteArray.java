...
public final class ByteArray {
    ...
    public class MyInputStream extends InputStream {
        ...
        public int read() {
            ...
            int unsignedByte0 = this.this$0.getUnsignedByte0(this.cursor);
            this.cursor++;
        ...
        public int read(byte[] bArr, int i, int i2) {
            ...
            int i3 = this.this$0.size - this.cursor;
            if (i2 > i3) {
                i2 = i3;
            }
            System.arraycopy(this.this$0.bytes, this.cursor + this.this$0.start, bArr, i, i2);
            this.cursor += i2;
            return i2;
        }
    ...
    public int getUnsignedByte0(int i) {
        return this.bytes[this.start + i] & ExifInterface.MARKER;
    }
    ...
    public long getLong(int i) {
        checkOffsets(i, i + 8);
        int byte0 = getByte0(i);
        int unsignedByte0 = getUnsignedByte0(i + 1);
        int unsignedByte02 = getUnsignedByte0(i + 2);
        return (((long) ((((byte0 << 24) | (unsignedByte0 << 16)) | (unsignedByte02 << 8)) | getUnsignedByte0(i + 3))) << 32) | (4294967295L & ((long) (getUnsignedByte0(i + 7) | (getByte0(i + 4) << 24) | (getUnsignedByte0(i + 5) << 16) | (getUnsignedByte0(i + 6) << 8))));
    }
    ...
    public ByteArray slice(int i, int i2) {
        ...
        int i3 = this.start;
        return new ByteArray(bArr, i + i3, i3 + i2);
    }
