...
public final class SsaBasicBlock {
    ...
    public SsaBasicBlock insertNewSuccessor(SsaBasicBlock ssaBasicBlock) {
        ...
        if (!this.successors.get(ssaBasicBlock.index)) {
            StringBuilder sbO = a.o("Block ");
            sbO.append(ssaBasicBlock.getRopLabelString());
            sbO.append(" not successor of ");
            sbO.append(getRopLabelString());
    ...
    public String toString() {
        ...
        sbO.append(this.index);
        sbO.append(Config.TRACE_TODAY_VISIT_SPLIT);
        sbO.append(Hex.u2(this.ropLabel));
        sbO.append('}');
        return sbO.toString();
    }
}
