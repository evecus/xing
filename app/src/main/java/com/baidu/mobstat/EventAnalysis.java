...
public class EventAnalysis {
    ...
    */
    ...
    public void onEventEnd(Context context, long j, String str, String str2, long j2, ExtraInfo extraInfo, Map<String, String> map, boolean z) {
        ...
        if (aVar == null) {
            bv.c().b("[WARNING] eventId: " + str + ", with label: " + str2 + " is not started or alread ended");
            return;
        }
        if ((str != null && !str.equals(aVar.a)) || (str2 != null && !str2.equals(aVar.b))) {
            bv.c().b("[WARNING] eventId/label pair not match");
            return;
        }
        this.a.remove(strA);
        long j3 = j2 - aVar.c;
        if (j3 < 0) {
            bv.c().b("[WARNING] onEventEnd must be invoked after onEventStart");
        }
    ...
    public void onEventStart(Context context, String str, String str2, long j) {
        if (cn.a().c()) {
            ...
            if (this.a.containsKey(strA)) {
                bv.c().b("[WARNING] eventId: " + str + ", with label: " + str2 + " is duplicated, older is removed");
            }
