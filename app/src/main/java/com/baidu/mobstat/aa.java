...
public class aa {
    ...
    private void a(byte[] bArr, byte[] bArr2, ByteBuffer byteBuffer, ByteBuffer byteBuffer2) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (i2 == i - 1) {
                z.a(byteBuffer, byteBuffer2, byteBufferA, iRemaining % 64);
            } else {
                z.a(byteBuffer, byteBuffer2, byteBufferA, 64);
            }
        }
    }
    ...
    void a(ByteBuffer byteBuffer, byte[] bArr, byte[] bArr2) {
        ...
        a(bArr2, ad.a(), byteBuffer, ByteBuffer.wrap(bArr));
    }
    ...
    byte[] a(ByteBuffer byteBuffer) throws GeneralSecurityException {
        ...
        a(bArr, ad.b(), byteBufferAllocate, byteBuffer);
