...
public class LuaThread extends Thread implements Runnable, LuaMetaTable, LuaGcable {
    ...
    public class ThreadHandler extends Handler {
        public final LuaThread this$0;

        private ThreadHandler(LuaThread luaThread) {
            this.this$0 = luaThread;
        }
        ...
        public void handleMessage(Message message) {
            ...
            int i = message.what;
            if (i == 0) {
                this.this$0.newLuaThread(data.getString("data"), (Object[]) data.getSerializable("args"));
                return;
            }
            if (i == 1) {
            ...
            if (i == 2) {
                this.this$0.newLuaThread(data.getString("data"), new Object[0]);
            } else if (i == 3) {
    ...
    private void initLua() {
        ...
        if (!(luaContext instanceof LuaActivity) && !(luaContext.getContext() instanceof Application)) {
            ...
            this.L.pop(1);
            new JavaFunction(this, this.L) { // from class: com.androlua.LuaThread.2
                public final LuaThread this$0;
            ...
            new JavaFunction(this, this.L) { // from class: com.androlua.LuaThread.3
                public final LuaThread this$0;
    ...
    public Object __index(String str) {
        return new LuaMetaTable(this, str) { // from class: com.androlua.LuaThread.1
            public final LuaThread this$0;
